...
public class FragmentRegisterBindingImpl extends FragmentRegisterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.appBarLayout2, 1);
        sViewsWithIds.put(R.id.emailTextField, 2);
        sViewsWithIds.put(R.id.et_email, 3);
        sViewsWithIds.put(R.id.passwordTextField, 4);
        sViewsWithIds.put(R.id.et_password, 5);
        sViewsWithIds.put(R.id.btn_register, 6);
    }
    // views
    @NonNull
